...
- (instancetype)initWithCoder:(NSCoder *)aDecoder __attribute__((unavailable("Use -initWithDataSource: instead")));

- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil __attribute__((unavailable("Use -initWithDataSource: instead")));
