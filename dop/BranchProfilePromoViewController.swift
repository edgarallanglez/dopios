//
//  BranchPromoViewController.swift
//  dop
//
...
class BranchProfilePromoViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    var coupons = [Coupon]()
    ...
    func getCoupons() {
        ...
        CouponController.getAllCouponsByBranchWithSuccess(branch_id!,
